...
//***CONSTRUCTORS***//
// Default constructor
Character::Character() : name("Nameless One"), hit_points(1),
    attr({{"STR", 10.0},{"INT", 10.0}, {"WIS", 10.0}, {"DEX", 10.0},
        {"CON", 10.0}, {"CHA", 10.0}}), skills({}), combat({}),
...
Character::Character(Character& c)
    ...
    histories(c.histories), cultures(c.cultures), supernatural(c.supernatural),
    elder_races(c.elder_races) {}

//***METHODS***//
std::vector<float> Character::progress_algorithm(std::map<std::string, float> stat,
    int quality) {
